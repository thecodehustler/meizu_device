...
ifeq (aosp_m5note,$(TARGET_PRODUCT))	#this is included only in lineage atm as some other roms have issue with this
PRODUCT_DEFAULT_PROPERTY_OVERRIDES += \
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/ramdisk/fstab.mt6755:root/fstab.mt6755 \
	$(LOCAL_PATH)/ramdisk/init.modem.rc:root/init.modem.rc \
	$(LOCAL_PATH)/ramdisk/init.mt6755.rc:root/init.mt6755.rc \
	$(LOCAL_PATH)/ramdisk/init.mt6755.usb.rc:root/init.mt6755.usb.rc \
	$(LOCAL_PATH)/ramdisk/init.project.rc:root/init.project.rc \
	$(LOCAL_PATH)/ramdisk/ueventd.mt6755.rc:root/ueventd.mt6755.rc \
...
# Include symbols
LINKER_FORCED_SHIM_LIBS := /system/lib/liblog.so:/system/lib64/liblog.so
LINKER_FORCED_SHIM_LIBS := $(LINKER_FORCED_SHIM_LIBS):/system/lib/hw/audio.primary.$(TARGET_BOARD_PLATFORM).so
LINKER_FORCED_SHIM_LIBS := $(LINKER_FORCED_SHIM_LIBS):/system/lib/libui.so:/system/lib64/libui.so
